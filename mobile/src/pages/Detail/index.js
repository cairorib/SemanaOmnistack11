...
export default function Detail(){
  ...
  const message= `Ola, ${incident.name}, estou entrando em contato para ajudar no caso de ${incident.title}`;
  ...
  function sendEmail(){
    MailComposer.composeAsync({
      subject:`Ajudante no caso de , ${incident.title}`,
  ...
  return(
    ...
    <View style={styles.container}>
      ...
      <View style={styles.contactBox}>
        <Text style={styles.heroTitle}> Ajude alguem!</Text>
        <Text style={styles.heroTitle} > Candidate-se</Text>
